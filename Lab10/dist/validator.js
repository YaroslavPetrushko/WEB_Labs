...
export function validateEmailWithMessage(email) {
    ...
    const allowedDomains = ['gmail.com', 'ukr.net', 'i.ua', 'outlook.com'];
 ...
 */
export function validateUsernameWithMessage(username) {
    const trimmedUsername = username.trim();
    if (!trimmedUsername) {
 ...
 */
export function validateBirthdateWithMessage(birthdate) {
